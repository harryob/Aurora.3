    ...
    <Window>
      <Window.Content>
        <Section title="Atmos Scrubber">
          <LabeledList>
            ...
            <LabeledList.Item label="Cell Charge">
              <ProgressBar {...cell_charge_color} minValue={0} maxValue={data.cellMaxCharge} value={data.cellCharge}>
                {data.cellCharge}
              </ProgressBar>
            </LabeledList.Item>
          </LabeledList>
        ...
        <Section title="Holding Tank">
          <LabeledList>
            <LabeledList.Item label="Tank Label" buttons={
              <Button icon="eject"
                onClick={() => act('removeTank')}
              />
            }>
              {data.holdingTankName}
            </LabeledList.Item>
            <LabeledList.Item label="Tank Pressure">
              <ProgressBar {...tank_presure_color} minValue={0} maxValue={1024} value={data.holdingTankPressure}>
        ...
        <Section title="Power Regulator Status">
          <LabeledList>
            ...
            <Slider
                ...
                onChange={(e, value) => act("setVolume",{targetVolume:value})}
              >
                {data.rate}
              </Slider>
            </LabeledList.Item>
